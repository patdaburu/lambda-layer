...
setup(
    name='lambda-layer',
    description="Create lambda layers for your python dependencies!",
    ...
    entry_points="""
    [console_scripts]
    lambda-layer=lambda_layer.cli:cli
    """,
    ...
    url= 'https://github.com/patdaburu/lambda_layer',
    download_url=(
        f'https://github.com/patdaburu/'
        f'lambda_layer/archive/{version}.tar.gz'
    ),
    keywords=[
